...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.5\textwidth]{doxygen_diagram.png}
...
\begin{figure}
  ...
  \begin{subfigure}[b]{0.5\textwidth}
      \centering
      \includegraphics[width=\textwidth]{before_troficus.png}
  ...
  \begin{subfigure}[b]{0.5\textwidth}
      \centering
      \includegraphics[width=\textwidth]{after_troficus.png}
